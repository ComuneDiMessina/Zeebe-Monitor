...
public interface IElementInstanceMapper {
	...
	ElementInstanceDomain map (ElementInstanceDocument elementInstanceEntity);
	List<ElementInstanceDomain> map(Iterable<ElementInstanceDocument> elementInstanceEntityIterable);
