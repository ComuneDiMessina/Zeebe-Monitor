...
public interface IWorkflowInstanceMapper {
	
	WorkflowInstanceDomain map(WorkflowInstanceDocument workflowInstanceEntity);
	List<WorkflowInstanceDomain> map(Iterable<WorkflowInstanceDocument> workflowInstanceEntityIterable);
