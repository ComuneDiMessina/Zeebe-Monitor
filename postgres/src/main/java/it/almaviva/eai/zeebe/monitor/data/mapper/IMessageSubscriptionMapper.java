...
public interface IMessageSubscriptionMapper {
	...
	MessageSubscriptionDomain map(MessageSubscriptionEntity messageSubscriptionEntity);
	List<MessageSubscriptionDomain> map(Iterable<MessageSubscriptionEntity> messageSubscriptionEntityIterable);
