...
public class WorkflowRepository implements IWorkflowPort {
	...
	public WorkflowDomain findByKey(long key) {
		Optional<WorkflowEntity> byKey = springDataWorkflowRepository.findByKey(key);
		WorkflowEntity workflowEntity = byKey.orElseThrow(() -> new EntityNotFoundException("[id]: "+ key));
	...
	public List<WorkflowDomain> findAll() {
		Iterable<WorkflowEntity> findAll = springDataWorkflowRepository.findAll();
