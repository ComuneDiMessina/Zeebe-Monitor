...
public interface IWorkflowInstanceMapper {
	...
	WorkflowInstanceDomain map(WorkflowInstanceEntity workflowInstanceEntity);
	List<WorkflowInstanceDomain> map(Iterable<WorkflowInstanceEntity> workflowInstanceEntityIterable);
